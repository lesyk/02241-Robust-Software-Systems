...
public class CopyOfRabinKarpClass {
    ...
    public CopyOfRabinKarpClass(int R, char[] pattern) {
        throw new UnsupportedOperationException("Operation not supported yet");
    }

    public CopyOfRabinKarpClass(String pat) {
    ...
    public static void main(String[] args) {
        ...
        CopyOfRabinKarpClass searcher = new CopyOfRabinKarpClass(pat);
