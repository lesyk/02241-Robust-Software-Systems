...
import morpheusmatrix.CodeDependency;
...
public class StatisticsView extends ViewPart {
	 ...
	 */
	public static final String ID = "morpheusmatrix.views.SampleView";
	...
	class ViewContentProvider implements IStructuredContentProvider {
		...
		public Object[] getElements(Object parent) {
			return new String[] {
					...
					"Code duplication",
					"Lines of codes and their growth over time",
					"Analyze package/module/variable naming against proposed scheme",
					"Unit dependencies" };
		}
	}
	...
	public void createPartControl(Composite parent) {
		...
		PlatformUI.getWorkbench().getHelpSystem()
				.setHelp(viewer.getControl(), "MorpheusMatrix.viewer");
		makeActions();
		hookContextMenu();
	...
	private void makeActions() {
		...
		doubleClickAction = new Action() {
			...
			public void run() {
				...
				else if (obj.toString().equals("Unit dependencies")){
					CodeDependency counter = new CodeDependency();
					counter.count();
				}
